 ...
 */
class Register(r: mutable.HashMap[Int, MySymbol], s: SymbolCounter) {
  ...
  def setLong(data: MySymbol, num: Int) = reg(num & limit) = Main.simple(data)
